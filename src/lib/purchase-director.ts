...
const DIRECTOR_SYSTEM = [
  ...
  '- Everything else that is a PHYSICAL PRODUCT (electronics, gaming mouse, headphones, clothing, books, appliances, toys, accessories) → category "product", merchant "shopify" (preferred, a Shopify-powered store) or "amazon" if the item is clearly mass-market (electronics, books, everyday goods).',
  '',
  'ITEM EXTRACTION:',
  ...
  '  "merchant": "swiggy" | "zepto" | "shopify" | "amazon",',
